...
Vendored verbatim from https://github.com/TinyPedal/pyLMUSharedMemory (MIT
license, see LICENSE.txt in this folder) for the VSD Paddock fuel/energy
companion app. Do not edit — if the struct layout changes upstream, replace
this file wholesale rather than patching it, otherwise offsets silently
desync and every field after the edit reads garbage.
"""
